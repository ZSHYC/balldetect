...
当前实验：[冻结层间点特征与真实候选重排](experiments/2026-09-15-blurball-layer-points.md)已完成三组30轮，未通过联合增益条件；保留原center5+hflip。
...
1. 先读[阶段进展](#阶段进展)与[当前实证修订](research/2026-09-10-empirical-reframing.md)的后续补充，确认哪些解释已得到支持、哪些配方已停止，再决定下一项工作。
2. 需要完整问题框架时读[第二轮研究总纲](research/高速微小球运动表征_第二轮第一性原理与对抗性研究总纲_2026-09-10.md)；追溯最初设想时读[立项蓝图](research/高速微小球运动表征_论文立项与实验蓝图_2026-09-09.md)和[第一轮审查](research/高速微小球运动表征_研究审查与反馈_2026-09-09.md)。
...
- [固定权重历史输入诊断](experiments/2026-09-13-blurball-history-input-probe.md)：重复当前输入未修复既定失败，约束后续候选证据检查。
...
- [Shuttlecock 联合支持与极端位移](experiments/2026-09-12-shuttlecock-extreme-motion.md)：训练侧近两帧联合几何覆盖与四例真实帧核对，区分最大标签跳变、真实快速球迹和未确认端点。
...
- [BlurBall时序输入控制结果](experiments/2026-09-12-blurball-temporal-control.md)：采用repeat最佳第1轮权重，完成全部验证match的共同读出与位置/输出状态配对。
...
- [2026-09-15：层间证据诊断结束](progress/2026-09-15-layer-evidence.md)：三层缓存读出均无联合定位增益，继续研究候选形成与时空证据。
