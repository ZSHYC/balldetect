...
**2026-09-13时域更新。** 用户已允许未来帧，正在执行[中心五帧与因果五帧协议](../protocols/blurball-five-frame-context-v1.md)。下文“三帧因果”保留当时比较语境，不限制当前项目；BIRD/STSN的原始未来信息应按新目标时域重新比较，不能只因非因果而排除。该变化不自动批准DCN或递推分支。
