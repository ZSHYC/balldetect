...
日期：2026-09-11。本文保留实验前的文献审查与判据；后续实际统计和判断见[读出集中度实验](../experiments/2026-09-11-readout-concentration.md)。2026-09-12 又补读了[整体匹配误差新稿](2026-09-12-coarse-fine-uncertainty.md)，它针对 coarse/fine correspondence，不改变本项全图位置分布诊断的任务定义。
